...
const translations = {
    en: {
        ...
        jadenText: "Antonio spearheads strategic direction, bridging activism and academia. A proud Bori‑buddy dedicated to uplifting new voices.",
        kristenRole: "Co-President",
        kristenText: "Aryana shares Co‑President duties, ensuring every DB initiative highlights our community’s creativity.",
        elyseRole: "Event Coordinator",
        elyseText: "Gabriella orchestrates events—from cooking nights to cultural showcases—to create a true familia gathering.",
        aryanaRole: "Social Media Manager",
        aryanaText: "Olivia fosters partnerships and community engagement, forging alliances that amplify DB’s mission.",
...
// Spring 2026 Events - Temporary
    ...
    es: {
        ...
        blackHeroParagraph: "Despierta Boricua es un movimiento político-cultural. Elevamos, empoderamos y celebramos nuestra cultura, historia y comunidad.",
...
questionsHeading: "Preguntas Orientadoras para un Estudio Profundo",
        ...
        jadenText: "Antonio dirige la estrategia, conectando activismo y academia. Un orgulloso Bori‑amigo comprometido con elevar nuevas voces.",
        kristenRole: "Co‑Presidente",
        kristenText: "Aryana comparte funciones de Co‑Presidente, asegurando que cada iniciativa de DB destaque la creatividad de nuestra comunidad.",
        elyseRole: "Coordinadora de Eventos",
        elyseText: "Gabriella organiza eventos—desde noches culinarias hasta exhibiciones culturales—para crear una verdadera reunión familiar.",
        aryanaRole: "Gerente de Redes Sociales",
        aryanaText: "Olivia fomenta alianzas y participación comunitaria, fortaleciendo la misión de DB.",
        alannaRole: "Tesorera",
        alannaText: "Daniel administra la salud financiera de DB, garantizando que cada proyecto sea viable y se mantenga dentro del presupuesto.",
        ...
        FabiRole: "Gerente de Redes Sociales",
        textoFabiola: "Fabiola, nuestra Enlace de Posgrado y Copresidenta de Networking, conecta a las comunidades de posgrado y pregrado mientras impulsa y amplifica las voces puertorriqueñas.",
        antonioRole: "Mentor de Primer Año",
        antonioText: "Nina conecta a los nuevos Yalies con DB con su cafecitos.",
